...
const Intro_CashReceipts = () => {
    return (
        <div className='object-fill max-w-[1240px] mx-auto px-4 text-white whitespace-nowrap h-fit' style={{
            ...
            <h3 className='mt-6 mb-2 text-2xl text-center font-bold'>
                국세청 홈페이지에 등록된<br />
                본인 인증 매체를 통해<br />
            ...
            <button className='object-fill md:place-items-center bg-[#D2302C] text-center w-[200px] mt-4 mb-6 rounded-lg font-bold px-3 py-3 text-white text-xl place-items-center'>서비스 신청하기</button>
        </div>
    )
};
